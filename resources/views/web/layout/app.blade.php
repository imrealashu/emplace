...
<head>
    ...
    <title>EmplaceMe - Retain your customers</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="apple-touch-icon" href="{{URL::asset('web/apple-touch-icon.png')}}">
    <link rel="icon" type="image/png" href="{{URL::asset('web/favicon-32x32.png')}}" sizes="32x32" />
    <link rel="icon" type="image/png" href="{{URL::asset('web/favicon-16x16.png')}}" sizes="16x16" />
    <link rel="stylesheet" href="{{URL::asset('web/css/normalize.min.css')}}">
    <link rel="stylesheet" href="{{URL::asset('web/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{URL::asset('web/css/jquery.fancybox.css')}}">
    <link rel="stylesheet" href="{{URL::asset('web/css/flexslider.css')}}">
    <link rel="stylesheet" href="{{URL::asset('web/css/styles.css')}}">
...
@yield('content')
    ...
    <script src="{{URL::asset('web/js/scripts.js')}}"></script>
